...
use super::utils::{shl, shr, Hash, HashImpl, from_base16, from_string_to_hexa};
...
pub impl TransactionValidatorImpl of TransactionValidator {
    ...
    fn txid(self: @Transaction) -> Hash {
        ...
        let txid_input: @ByteArray = from_string_to_hexa(
...
mod tests {
    ...
    //         let target: u256 =
    //         0x00000000000000000007a4290000000000000000000000000000000000000000;
    //         let work = compute_work_from_target(target);
    //         assert(expected_work == work, 'Failed to compute target');
    //     }
    ...
    //         let block = Block {
    //             header: Header { version: 1_u32, time: 1231006505_u32, bits: 1, nonce:
    //             2083236893_u32 }, txs: array![
    //                 Transaction {
    //                     version: 1,
    //                     is_segwit: false,
    //                     inputs: array![
    ...
    //                     ]
    //                         .span(),
    //                     outputs: array![TxOut { value: 5000000000_u64, pk_script:
    //                     from_base16(""), }]
    //                         .span(),
    //                     lock_time: 0
    //                 }
    ...
    //                             sequence: 4294967295,
    //                             previous_output: OutPoint {
    //                                 txid: 0_u256.into(), vout: 0x1_u32, txo_index: 0, amount:
    //                                 0_64
    //                             },
    //                             witness: from_base16("0")
    //                         }
